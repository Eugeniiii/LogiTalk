...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.bg_theme = CTkOptionMenu(self.frame, values = ["Стандартна", "Білий", "Чорний", "Сірий", "Червоний", "Зелений", "Блакитний"], command = self.change_bg_color)
        self.bg_theme.pack(side='bottom', pady=20)
    ...
    def change_bg_color(self, value):
        if self.current_appearance_mode == "dark":
            if value == "Стандартна":
                self.chat_text.configure(bg_color = "#1d1e1e")
            elif value == "Білий":
                self.chat_text.configure(bg_color = "#e9efef")
        elif self.current_appearance_mode == "light":
            if value == "Стандартна":
                self.chat_text.configure(bg_color = "#f9f9fa")
            elif value == "Білий":
                self.chat_text.configure(bg_color = "#f5efef")
